...
export default function FindUs() {
  return (
    <section className="my-24 text-gray-800">
      <div className="block rounded-lg shadow-lg bg-white">
        <div className="flex flex-wrap items-center">
          <div className="grow-0 shrink-0 basis-auto block h-96 w-full lg:flex lg:w-6/12 xl:w-4/12">
            <div className="h-full w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7877439755043!2d107.6316106228332!3d-6.91596177901963!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e762bcfe2e9d%3A0xdb1effda3e6038be!2sPT.%20Garsi%20Jembar%20Niaga!5e0!3m2!1sid!2sus!4v1670461771449!5m2!1sid!2sus"
                loading="lazy"
              ...
              <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div className="flex items-start">
                  ...
                  <div className="grow ml-6">
                    ...
                    <p className="text-gray-500">+62 853 406 211 39</p>
                  </div>
                </div>
              </div>
              <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div className="flex align-start">
                  ...
                  <div className="grow ml-6">
                    ...
                    <p className="text-gray-500">pt_garsijembarniaga</p>
                  </div>
                </div>
              </div>
              <div className="mb-12 lg:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div className="flex align-start">
                  ...
                  <div className="grow ml-6">
                    ...
                    <p className="text-gray-500">juanfirmansyah.jf@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
